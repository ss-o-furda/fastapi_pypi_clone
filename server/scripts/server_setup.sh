...
chmod 777 /apps
mkdir /apps/logs
mkdir /apps/logs/fastapi_pypi_clone_api
mkdir /apps/logs/fastapi_pypi_clone_api/app_log
# chmod 777 /apps/logs/weather_api
setfacl -m u:apiuser:rwx /apps/logs/fastapi_pypi_clone_api
# cd /apps
...
certbot --nginx -d pypi_clone.talkpython.com